...
<!-- Book mention functionality -->
<script src="{{ asset('js/book-mention.js') }}"></script>

<script>
    $(document).ready(function() {
        try {
            // Slick Slider Initialization - thêm kiểm tra xem slick có tồn tại không
            if (typeof $.fn.slick === 'function') {
                ...
                console.warn('Slick không được tìm thấy. Vui lòng kiểm tra thư viện slick.js');
            }
        } catch (e) {
            console.error('Lỗi khi khởi tạo slick slider:', e);
        }
