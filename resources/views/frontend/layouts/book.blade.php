...
<section id="limited-offer" class="padding-large d-flex align-items-center"
    style="background-image: url('{{ asset('frontend/assets_f/images/banner-image-bg-1.jpg') }}'); background-size: cover; background-repeat: no-repeat; background-position: center; height: 500px;">
    <div class="container">
        <div class="row d-flex align-items-center">
            ...
            <div class="col-md-5 offset-md-1 mt-5 mt-md-0 text-center text-md-start">
                ...
                <p>Tham gia sự kiện đọc sách trực tuyến và khám phá những đầu sách mới đầy hấp dẫn.</p>
                ...
                <a href="" class="btn btn-outline-primary mt-3">Xem chi tiết sự kiện</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
                <div class="featured border rounded-3 p-4">
                    <div class="section-title overflow-hidden mb-5 mt-2">
                        <h3 class="d-flex flex-column mb-0">Đề cử</h3>
                    </div>
                        ...
                        <div class="items-lists">
                            <div class="item d-flex">
                                ...
                                <div class="item-content ms-3">
                                    <h6 class="mb-0 fw-bold"><a href="{{ route('front.book.show', $book->slug) }}">{{ Str::limit($book->title, 15) }}</a></h6>
                                    <div class="review-content d-flex">
                                        <p class="my-2 me-2 fs-6 text-black-50">
            ...
            <div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
                <div class="latest-items border rounded-3 p-4">
                    <div class="section-title overflow-hidden mb-5 mt-2">
                        <h3 class="d-flex flex-column mb-0">Mới đăng</h3>
                    </div>
            ...
            <div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
                <div class="best-reviewed border rounded-3 p-4">
                    <div class="section-title overflow-hidden mb-5 mt-2">
                        <h3 class="d-flex flex-column mb-0">Đọc nhiều </h3>
                    </div>
