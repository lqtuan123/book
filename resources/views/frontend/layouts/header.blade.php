            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar"
                ...
                <div class="offcanvas-body">
                    <ul id="navbar"
                        ...
                        <li class="nav-item">
                            <a class="nav-link me-4 active" href="{{ route('home') }}">Trang chủ</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link me-4" href="{{ route('front.book.index') }}">Thư viện sách</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link me-4" href="{{ route('front.tblogs.index') }}">Cộng đồng</a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link me-4" href="{{ route('contact') }}">Liên hệ</a>
                        </li>
                    </ul>
