...
<aside id="left-sidebar" class="sidebar lg:w-1/5 lg:pr-4 mb-6 lg:mb-0">
    <div class="bg-white rounded-lg shadow-sm p-4">
        ...
        <!-- Profile Menu -->
        <div class="space-y-1">
            <a href="#posts" class="tab-link flex items-center px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-md"
                data-tab="posts">
                <i class="fas fa-newspaper mr-3 text-lg"></i>
                <span>Bài viết đã đăng</span>
            </a>
            <a href="#personal-info"
                class="tab-link flex items-center px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-md"
                data-tab="personal-info">
                <i class="fas fa-user-circle mr-3 text-lg"></i>
                <span>Thông tin cá nhân</span>
            </a>
            <a href="#books" class="tab-link flex items-center px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-md"
                data-tab="books">
                <i class="fas fa-book mr-3 text-lg"></i>
                <span>Sách đã đăng</span>
            </a>
            <a href="#likes" class="tab-link flex items-center px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-md"
                data-tab="likes">
        ...
        <div class="mt-6 pt-4 border-t border-gray-200">
            ...
            <div class="space-y-2">
                ...
                <div class="flex justify-between text-sm">
                    <span class="text-gray-600">Lượt xem sách:</span>
                    <span class="font-medium">{{ $totalBookViews ?? 0 }}</span>
                </div>
                <div class="flex justify-between text-sm">
                    <span class="text-gray-600">Lượt xem bài viết:</span>
                    <span class="font-medium">{{ $totalBlogViews ?? 0 }}</span>
                </div>
            </div>
