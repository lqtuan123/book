...
background-size: cover; background-repeat: no-repeat; background-position: center; height: 400px;">
    ...
    <section
        class="  top-space-margin page-title-big-typography cover-background overflow-hidden position-relative p-0 border-radius-10px lg-no-border-radius"
        style="background-image: url({{ isset($page->banner) ? $page->banner : 'https://via.placeholder.com/1920x600' }})">
    ...
    <section class="overlap-section text-center p-0 sm-pt-50px">
        ...
        <h1 style="font-size:200% !important; text-transform: uppercase;" class="text-dark-gray fw-700"> {{ $page->title }}
        </h1>
    ...
    <div id="edit-popup" class="popup" onclick="closePopupOnBackgroundClick(event)">
        <div class="popup-content">
            ...
            <form id="updateForm" enctype="multipart/form-data" method="POST"
                action="{{ route('front.tpage.updateimage') }}">
                @csrf
